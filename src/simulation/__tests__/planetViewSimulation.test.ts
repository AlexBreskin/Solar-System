...
describe('computeScaledLayout', () => {
  ...
  it('all moons appear in moonOrbitalRadii and moonSizes', () => {
    ...
    const layout = computeScaledLayout('jupiter', moons, W, H, CELESTIAL_BODIES);
  ...
  it('outer moons have larger orbital radii than inner moons', () => {
    const layout = computeScaledLayout('jupiter', getMoonsOf('jupiter', CELESTIAL_BODIES), W, H, CELESTIAL_BODIES);
