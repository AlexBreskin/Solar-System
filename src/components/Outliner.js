      ...
      >
        ...
        <span
          ...
          style={{
            ...
            boxShadow: isSelected ? `0 0 6px ${body.color}` : "none",
          }}
        />
...
// Flat list used in Planet View — just the planet + its moons, no tree nesting
    ...
    <div className="outliner">
      <div className="outliner-header">
        ...
        <span className="outliner-count">
          {isPlanetView
            ? filterIds.length
            : Object.keys(CELESTIAL_BODIES).length}
        </span>
      </div>
      <div className="outliner-scroll">
        {isPlanetView ? (
          <>
            ...
            />
            {moonIds.length > 0 && (
              <div className="outliner-section-label">
                Moons ({moonIds.length})
              </div>
            )}
            {moonIds.map((id) => (
              <FlatOutlinerRow
